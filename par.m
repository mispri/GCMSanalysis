...
%frag 3 is the cleanest
AN(i).frag.good = [0 0 1 0 0]; %recheck 1 and 2
...
AN(i).frag.autoweight = [1 1 1 0 1]; 
AN(i).frag.fitweight = [1 1 1 0 1]; 
%frag 4 is bad, frag 2 and 3 have anepluerotic effect
AN(i).frag.good = [1 1 1 0 1];
...
AN(i).frag.autoweight = [0 0 1 0 0]; 
AN(i).frag.fitweight = [0 0 1 0 0];
...
AN(i).range=[1460 1540]+offset;
AN(i).frag.names = {'-15' '-57' '-85' '-159' 'f302'};
AN(i).frag.mz = [482 440 412 338 302]; 
AN(i).frag.autoweight = [0 0 0 0 1]; 
AN(i).frag.fitweight = [0 0 0 0 1]; 
AN(i).frag.good = [0 0 0 0 0]; 
...
AN(i).frag.autoweight = [1 0 1 1 0]; 
AN(i).frag.fitweight = [1 0 1 1 0]; 
AN(i).frag.good = [1 0 1 1 0]; 
...
AN(i).frag.autoweight = [0 1 1 0 1];%A tiny bit of background in 2 and 3 also
AN(i).frag.good = [0 1 1 0 1]; %might be okay with 1 and 4 after background correct
...
AN(i).frag.autoweight = [1 0 1 0 1];
AN(i).frag.fitweight = [1 0 1 0 1]; 
AN(i).frag.good = [1 1 1 0 1]; 
AN(i).frag.show = [1 1 1 1 1]; 
